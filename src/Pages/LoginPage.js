...
const LoginForm = () => {
  ...
  return (
      <div className=" bg-no-repeat bg-cover h-screen w-screen flex items-center justify-center bg-[url('https://media.istockphoto.com/id/1218851416/vi/anh/tr%E1%BB%91ng-d%E1%BA%A7u-ng%E1%BB%93i-tr%C3%AAn-m%E1%BB%99t-b%E1%BA%A3ng-giao-d%E1%BB%8Bch-%C4%91ang-cho-th%E1%BA%A5y-m%E1%BB%99t-s%E1%BB%B1-s%E1%BB%A5p-%C4%91%E1%BB%95-th%E1%BB%8B-tr%C6%B0%E1%BB%9Dng-ch%E1%BB%A9ng-kho%C3%A1n.webp?b=1&s=170667a&w=0&k=20&c=evL9Dc4jnerZjgnvvCo-P5MgQmSyP2BVAqMg49poGTA=')]">
        <form onSubmit={handleLogin} className="w-1/2 mx-auto bg-black bg-opacity-80 rounded-lg py-5 md:h-[400px] flex flex-row justify-evenly items-center">
          <div className="bg-[url('https://media.istockphoto.com/id/1386523365/vi/anh/hai-th%C3%B9ng-d%E1%BA%A7u-v%C3%A0ng-tr%C3%AAn-m%C3%A0n-h%C3%ACnh-k%E1%BB%B9-thu%E1%BA%ADt-s%E1%BB%91.webp?b=1&s=170667a&w=0&k=20&c=duRSQzTUPWgmREbzCrGk6z3TE1_URifjPeJdxjNjCps=')] w-1/2 h-[100%] bg-no-repeat bg-cover"></div>
          <div>
